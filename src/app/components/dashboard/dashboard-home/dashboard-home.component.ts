...
export class DashboardHomeComponent implements OnInit {
  ...
  constructor(private productService: ProductsService, private userService: UserService, private orderService: OrdersService, private router:Router ) { }
  ...
  ngOnInit(): void {
    ...
    this.productService.getProductCount().subscribe(
      ...
      (err) => {console.error(err); this.router.navigate(['/home'])},
    );
